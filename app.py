    ...
    for session in user_sessions:
        for exercise in session.exercises:
            if exercise.exercise_type not in progress_data:
                progress_data[exercise.exercise_type] = {'dates': [], 'weights': []}
...
def dashboard():
    ...
    muscle_group_exercises = {
        ...
        'Руки': ['Разгибания на трицепс с канатной рукоятью в кроссовере', 'Сгибания на бицепс в РТ', 'Подъем на бицепс штанги обратным хватом'],
        'Ягодицы': ['Ягодичный мост в РТ'],
        'Ноги': ['Разгибание голени в БТ', 'Сгибание голени в БТ', 'Икроножные в Т'],
        'Спина': ['Вертикальная тяга сидя', 'Горизонтальная тяга', 'Экстензия']
    }
    ...
    if request.method == 'POST':
        try:
            ...
            exercise_database = {
                ...
                'biceps': ['Сгибания на бицепс в РТ', 'Подъем на бицепс штанги обратным хватом'],
                'legs': ['Ягодичный мост в РТ', 'Разгибание голени в БТ', 'Сгибание голени в БТ', 'Икроножные в Т'],
                'shoulders': ['Вращения гантелей в согнутых руках', 'Вертикальная тяга сидя'],
                'back': ['Горизонтальная тяга', 'Экстензия'],
                'forearms': ['Сгибания в предплечьях', 'Работа с гирей на предплечья']
            }
            ...
            if not selected_exercises:
                selected_exercises = ['Жим лежа', 'Сгибания на бицепс в РТ', 'Горизонтальная тяга']
...
def calculate_calories():
    ...
    met_values = {
        ...
        'Сгибания на бицепс в РТ': 4.0,
        'Подъем на бицепс штанги обратным хватом': 4.5,
        'Ягодичный мост в РТ': 5.5,
        'Разгибание голени в БТ': 5.0,
        'Сгибание голени в БТ': 5.0,
        'Икроножные в Т': 4.0,
        'Вращения гантелей в согнутых руках': 3.5,
        'Вертикальная тяга сидя': 6.0,
        'Горизонтальная тяга': 6.0,
        'Экстензия': 5.5,
        'Сгибания в предплечьях': 3.0,
        'Работа с гирей на предплечья': 4.0
    }
